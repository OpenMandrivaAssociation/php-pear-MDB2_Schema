...
install -d %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Reserved
...
install %{_pearname}-%{version}/%{_class}/%{_subclass}/Reserved/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Reserved
